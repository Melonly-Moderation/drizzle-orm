...
export class MySqlInsertBase extends QueryPromise {
    session;
    dialect;
    ...
    constructor(table, values, ignore, session, dialect, select) {
        ...
        this.session = session;
        this.dialect = dialect;
        this.config = { table, values: values, select, ignore };
    }
    /**
    ...
    prepare() {
        ...
        return this.session.prepareQuery(this.dialect.sqlToQuery(sql), undefined, undefined, generatedIds, this.config.returning);
    }
