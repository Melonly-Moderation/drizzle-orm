...
export class RelationalQueryBuilder {
    ...
    findFirst(config) {
        return new SingleStoreRelationalQuery(this.fullSchema, this.schema, this.tableNamesMap, this.table, this.tableConfig, this.dialect, this.session, config ? { ...config, limit: 1 } : { limit: 1 }, 'first');
    }
}
export class SingleStoreRelationalQuery extends QueryPromise {
    fullSchema;
    schema;
    tableNamesMap;
    table;
