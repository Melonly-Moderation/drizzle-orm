...
export class SingleStoreEnumColumnBuilder extends SingleStoreColumnBuilder {
...
export class SingleStoreEnumColumn extends SingleStoreColumn {
...
export function singlestoreEnum(a, b) {
