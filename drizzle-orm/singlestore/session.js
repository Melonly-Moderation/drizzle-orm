...
import { SingleStorePreparedQuery, SingleStoreSession, SingleStoreTransaction, } from '~/singlestore-core/session.ts';
import { fillPlaceholders, sql } from '~/sql/sql.ts';
import { mapResultRow } from '~/utils.ts';
export class SingleStoreDriverPreparedQuery extends SingleStorePreparedQuery {
    client;
    params;
    logger;
    fields;
...
export class SingleStoreDriverSession extends SingleStoreSession {
    client;
    schema;
    options;
    ...
    prepareQuery(query, fields, customResultMapper, generatedIds, returningIds) {
        ...
        return new SingleStoreDriverPreparedQuery(this.client, query.sql, query.params, this.logger, fields, customResultMapper, generatedIds, returningIds);
    }
    /**
     * @internal
     * What is its purpose?
    ...
    async transaction(transaction, config) {
        const session = isPool(this.client)
            ? new SingleStoreDriverSession(await this.client.getConnection(), this.dialect, this.schema, this.options)
            : this;
...
export class SingleStoreDriverTransaction extends SingleStoreTransaction {
