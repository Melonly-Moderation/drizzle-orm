...
export class SingleStoreSelectQueryBuilderBase extends TypedQueryBuilder {
    ...
    createJoin(joinType) {
        return (table, // | SingleStoreViewBase
        on) => {
...
export class SingleStoreSelectBase extends SingleStoreSelectQueryBuilderBase {
