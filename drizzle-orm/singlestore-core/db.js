...
import { QueryBuilder, SingleStoreDeleteBase, SingleStoreInsertBuilder, SingleStoreSelectBuilder, SingleStoreUpdateBuilder, } from './query-builders/index.ts';
export class SingleStoreDatabase {
    ...
    $count(source, // SingleStoreViewBase |
    filters) {
