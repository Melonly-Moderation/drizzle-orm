...
import { type SingleStoreColumnBuilders } from './columns/all.ts';
import type { SingleStoreColumn, SingleStoreColumnBuilderBase } from './columns/common.ts';
...
export declare class SingleStoreTable<T extends TableConfig = TableConfig> extends Table<T> {
    ...
    [x: number]: NonNullable<T["columns"]> | ((self: Record<string, SingleStoreColumn>) => SingleStoreTableExtraConfig) | undefined;
